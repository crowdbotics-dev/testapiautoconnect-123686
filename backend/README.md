...
## Project Structure
    ...
    ├── testapiautoconnect_123686  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_123686`
...
2. Clone this repo and `cd testapiautoconnect_123686`
